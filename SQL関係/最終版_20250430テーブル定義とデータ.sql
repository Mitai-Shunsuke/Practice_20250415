USE [TEST_DB]
GO
/****** Object:  Table [dbo].[IM_STAFF]    Script Date: 2025/04/30 15:16:52 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[IM_STAFF]') AND type in (N'U'))
DROP TABLE [dbo].[IM_STAFF]
GO
/****** Object:  Table [dbo].[IM_ITEM_CLASS]    Script Date: 2025/04/30 15:16:52 ******/
...
GO
/****** Object:  Table [dbo].[IM_ITEM]    Script Date: 2025/04/30 15:16:52 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[IM_ITEM]') AND type in (N'U'))
DROP TABLE [dbo].[IM_ITEM]
GO
/****** Object:  Table [dbo].[ID_IO_HISTORY]    Script Date: 2025/04/30 15:16:52 ******/
...
GO
INSERT [dbo].[ID_IO_HISTORY] ([HistoryCD], [IODate], [ItemCD], [IsReceived], [Moving], [StaffCD], [Remarks]) VALUES (1053, CAST(N'2025-04-08' AS Date), 11, 1, 3000, 1001, N'')
GO
INSERT [dbo].[ID_IO_HISTORY] ([HistoryCD], [IODate], [ItemCD], [IsReceived], [Moving], [StaffCD], [Remarks]) VALUES (1054, CAST(N'2025-04-24' AS Date), 11, 0, 100, 1001, N'')
GO
INSERT [dbo].[ID_IO_HISTORY] ([HistoryCD], [IODate], [ItemCD], [IsReceived], [Moving], [StaffCD], [Remarks]) VALUES (1064, CAST(N'2025-04-01' AS Date), 12, 1, 4000, 0, N'初期在庫')
GO
INSERT [dbo].[ID_IO_HISTORY] ([HistoryCD], [IODate], [ItemCD], [IsReceived], [Moving], [StaffCD], [Remarks]) VALUES (1069, CAST(N'2025-04-25' AS Date), 13, 1, 2500, 0, N'初期在庫')
GO
INSERT [dbo].[ID_IO_HISTORY] ([HistoryCD], [IODate], [ItemCD], [IsReceived], [Moving], [StaffCD], [Remarks]) VALUES (1109, CAST(N'2025-04-01' AS Date), 21, 1, 5000, 0, N'初期在庫')
GO
INSERT [dbo].[ID_IO_HISTORY] ([HistoryCD], [IODate], [ItemCD], [IsReceived], [Moving], [StaffCD], [Remarks]) VALUES (1110, CAST(N'2025-04-03' AS Date), 21, 1, 500, 0, N'')
GO
INSERT [dbo].[ID_IO_HISTORY] ([HistoryCD], [IODate], [ItemCD], [IsReceived], [Moving], [StaffCD], [Remarks]) VALUES (1111, CAST(N'2025-04-09' AS Date), 21, 1, 500, 0, N'')
GO
INSERT [dbo].[ID_IO_HISTORY] ([HistoryCD], [IODate], [ItemCD], [IsReceived], [Moving], [StaffCD], [Remarks]) VALUES (1112, CAST(N'2025-04-21' AS Date), 21, 0, 1000, 0, N'')
GO
